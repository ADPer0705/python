...
class Hand:
    ...
    # calculating the value of tha hand
    def calculate_value(self):
        ...
        for card in self.cards:
            ...
            if card.rank["rank"] == "A":
                has_ace = True
        # determining whether ace should be 11 or 1
        if has_ace and self.value > 21:
            self.value -= 10

    # getting the value of a hand
    def get_value(self):
        self.calculate_value()
        return self.value
    
    # Checking for black jack win
...
class Game:
    # This is the main class, this will control the gameplay
    def play(self):
        game_number = 0
        games_to_play = 0
    ...
    def check_winner(self, player_hand, dealer_hand, game_over=False):
        if not game_over:
            if player_hand.get_value() > 21:
                ...
                print("Both players have blackjakc! TIE!")
                return True
            elif player_hand.is_blackjack():
                print("You Have a Black Jack! you win!")
                return True
            elif dealer_hand.is_blackjack():
                print("Dealer Have a Black Jack! Dealer wins!")
                return True
        else:
